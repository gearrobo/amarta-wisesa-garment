<?php
// Setup script for supplier management system
require_once 'config/db.php';

echo "Setting up Supplier Management System...\n";

// SQL to create supplier table
$sql = "CREATE TABLE IF NOT EXISTS `suplier` (
...
$insert_sql = "INSERT INTO suplier (kode_suplier, nama_suplier, alamat, telepon, email, kontak_person, npwp, keterangan, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = mysqli_prepare($conn, $insert_sql);

foreach ($sample_data as $data) {
    mysqli_stmt_bind_param($stmt, "sssssssss", ...$data);
    mysqli_stmt_execute($stmt);
}

echo "✅ Sample data inserted successfully\n";
echo "✅ Setup complete! You can now access data-suplier.php in your browser\n";
